...
type Article struct {
	...
	CompanyId int    `json:"company_id" gorm:"not null comment('公司id') INT(3) 'company_id'"`
	...
	CategoryId int `json:"category_id" gorm:"not null comment('技术栈分类id') INT(3) 'category_id'"`
